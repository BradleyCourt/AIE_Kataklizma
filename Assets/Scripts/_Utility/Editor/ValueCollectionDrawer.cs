...
[CustomPropertyDrawer(typeof(ValueCollection.Value))]
public class ValueCollectionDrawer : UnityEditor.PropertyDrawer {
    ...
    public override void OnGUI(Rect position, SerializedProperty property, GUIContent label) {
        ...
        var value = new ValueCollection.Value { Base = property.FindPropertyRelative("Base").floatValue, Modifier = property.FindPropertyRelative("Modifier").floatValue };
